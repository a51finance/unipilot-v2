...
interface IUnipilotVault {
    ...
    /// @notice Pull in tokens from sender. Called to `msg.sender` after minting liquidity to a position from IPancakeV3Pool#mint.
    ...
    /// @notice Called to `msg.sender` after minting swaping from IPancakeV3Pool#swap.
