...
contract TokenDeltaMathEchidnaTest {
    ...
    function getNextSqrtPriceFromInputInvariants(
        ...
        uint160 sqrtQ = PriceMovementMath.getNewPriceAfterInput(
            sqrtP,
            liquidity,
            amountIn,
            zeroToOne
        ...
        if (zeroToOne) {
            ...
            assert(
                amountIn >=
                    TokenDeltaMath.getToken0Delta(sqrtQ, sqrtP, liquidity, true)
            );
        } else {
            assert(sqrtQ >= sqrtP);
            assert(
                amountIn >=
                    TokenDeltaMath.getToken1Delta(sqrtP, sqrtQ, liquidity, true)
            );
        }
    }
    ...
    function getNextSqrtPriceFromOutputInvariants(
        ...
        uint160 sqrtQ = PriceMovementMath.getNewPriceAfterOutput(
            sqrtP,
            liquidity,
            amountOut,
            zeroToOne
    ...
    function getNextSqrtPriceFromAmount0RoundingUpInvariants(
        ...
        if (add) {
            sqrtQX96 = PriceMovementMath.getNewPriceAfterInput(
                sqrtPX96,
                liquidity,
                amount,
                true
            ...
            sqrtQX96 = PriceMovementMath.getNewPriceAfterOutput(
                sqrtPX96,
                liquidity,
                amount,
                false
    ...
    function getToken0DeltaInvariants(
        ...
        uint256 amount0Down = TokenDeltaMath.getToken0Delta(
            sqrtQ,
            sqrtP,
            liquidity,
            false
        ...
        uint256 amount0Up = TokenDeltaMath.getToken0Delta(
            sqrtQ,
            sqrtP,
            liquidity,
            true
    ...
    function getToken0DeltaEquivalency(
        ...
        uint256 fullResult = TokenDeltaMath.getToken0Delta(
            sqrtQ,
            sqrtP,
            liquidity,
            roundUp
    ...
    function getToken1DeltaInvariants(
        ...
        uint256 amount1Down = TokenDeltaMath.getToken1Delta(
            sqrtP,
            sqrtQ,
            liquidity,
            false
        ...
        uint256 amount1Up = TokenDeltaMath.getToken1Delta(
            sqrtP,
            sqrtQ,
            liquidity,
            true
    ...
    function getInRangeMintInvariants(
        ...
        int256 amount0 = TokenDeltaMath.getToken0Delta(
            sqrtCurrent,
            sqrtUpper,
            liquidity
        );
        int256 amount1 = TokenDeltaMath.getToken1Delta(
            sqrtLower,
            sqrtCurrent,
            liquidity
        );
