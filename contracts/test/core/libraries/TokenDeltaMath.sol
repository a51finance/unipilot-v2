...
library TokenDeltaMath {
    ...
    function getToken0Delta(
        ...
        token0Delta = roundUp
            ...
            : FullMath.mulDiv(priceDelta, liquidityShifted, priceUpper) /
                priceLower;
    }
    ...
    function getToken0Delta(
        ...
        token0Delta = liquidity >= 0
            ? getToken0Delta(priceLower, priceUpper, uint128(liquidity), true)
                .toInt256()
            : -getToken0Delta(
                priceLower,
                priceUpper,
    ...
    function getToken1Delta(
        ...
        token1Delta = liquidity >= 0
            ? getToken1Delta(priceLower, priceUpper, uint128(liquidity), true)
                .toInt256()
            : -getToken1Delta(
                priceLower,
                priceUpper,
